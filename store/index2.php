...
<div id="wrapper">
	<div id="note">
		...
		Welcome to Sisco's great store
	</div>
	<div id="content">
		<div id="productlist">
			...
			{
				echo '<a href="index3.php?id='.$row['user_id'].'&trnasnum='.$transnum.'"><img src="img/products/'.$row['Pic'].'" alt="'.htmlspecialchars($row['username']).'" width="109" height="109" class="pngfix" /></a>';
			}
